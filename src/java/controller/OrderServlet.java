...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    // Kunin ang listahan ng orders sa session. Kung wala pa, gumawa ng bago.
    ...
    // I-save sa isang Map (isang row ng order)
...
newOrder.put("date", "April 1, 2026");
    ...
    // I-add yung bagong order sa listahan
    orderList.add(0, newOrder); // '0' para laging nasa taas yung pinakabago

    // I-save ulit yung updated na listahan sa session
