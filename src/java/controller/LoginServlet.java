...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 1. Hanapin ang user gamit ang helper method sa DataStore
        User foundUser = ds.findUserByUsername(un);

        // 2. I-verify kung nahanap ang user at kung tama ang password
        if (foundUser != null && foundUser.password.equals(pw)) {
            HttpSession session = request.getSession();
            
            // 3. I-load ang data mula sa User object (DataStore) patungong Session
            ...
            // 4. KUNIN ANG PICTURE - Dito tayo mag-fofocus
            ...
            // LOGGING: Tingnan mo ito sa Output Window ng NetBeans pagka-login mo
